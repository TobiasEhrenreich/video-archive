        ...
        if ($res->num_rows > 0) {
            ...
            echo "<div class=\"card text-center\">
                        <div class=\"card-body\">
                            ...
                            <p class=\"card-text\">These are all found videos that contain the search term \"" . $search . "\".</p>";
    ...
    if (!isset($_GET["search"]) AND !isset($_GET["id"])) {
        ...
        echo "<div class=\"card text-center\">
                    <div class=\"card-body\">
                        ...
                        <p class=\"card-text\">These are all uploaded videos on the platform. Please click on the corresponding title to proceed.</p>";
                        showData($connection, $res);
                    echo "</div>
             </div>";
    }
